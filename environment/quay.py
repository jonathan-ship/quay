...
class QuayScheduling:
    def __init__(self, df_quay, df_score, df_weight, df_ship, df_work, df_work_fixed, log_dir, duration=60, frame=60):
        ...
        self.action_size = len(self.df_quay) * 3 + 1
    ...
    def _get_state(self):
        ...
        f_2 = np.zeros(len(self.df_quay) * 3)  # 안벽 이동 가능 여부 (0.0, 0.25, 0.5, 0.75, 1.0)
